        ...
        if (window.screen.width > 1200) {
            return `
                <div class="suggestion_make_action">
                    <img
                        src="https://gleb001.github.io/FlappyBird-Gosha/images/suggestion_make_action/click_mouse.svg"
                        alt="click"
                    >
                </div>
                <div class="suggestion_make_action">
                    <img
                        src="https://gleb001.github.io/FlappyBird-Gosha/images/suggestion_make_action/button_space.svg"
                        alt="button space"
                    >
                </div>
            `;
            ...
            return `
                <div class="suggestion_make_action">
                    <img
                        src="https://gleb001.github.io/FlappyBird-Gosha/images/suggestion_make_action/click_arm.svg"
                        alt="tap"
                    >
                </div>
            `;
